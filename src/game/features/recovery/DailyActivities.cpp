...
{
	static ListCommand hiddenCacheIndex = {"hiddencacheindex", "隐藏缓存", "已选择的隐藏缓存", {{0, "隐藏缓存 1"}, {1, "隐藏缓存 2"}, {2, "隐藏缓存 3"}, {3, "隐藏缓存 4"}, {4, "隐藏缓存 5"}, {5, "隐藏缓存 6"}, {6, "隐藏缓存 7"}, {7, "隐藏缓存 8"}, {8, "隐藏缓存 9"}, {9, "隐藏缓存 10"}}};

	static ListCommand treasureChestIndex = {"treasurechestindex", "宝箱", "已选择的宝箱", {{0, "宝箱 1"}, {1, "宝箱 2"}}};

	static ListCommand buriedStashIndex = {"buriedstashindex", "埋藏藏匿物", "已选择的埋藏藏匿物", {{0, "埋藏藏匿物 1"}, {1, "埋藏藏匿物 2"}}};

	static ListCommand skydiveIndex = {"skydiveindex", "跳伞", "已选择的跳伞点", {{0, "Skydive 1"}, {1, "Skydive 2"}, {2, "Skydive 3"}, {3, "Skydive 4"}, {4, "Skydive 5"}, {5, "Skydive 6"}, {6, "Skydive 7"}, {7, "Skydive 8"}, {8, "Skydive 9"}, {9, "Skydive 10"}}};

	static ListCommand timeTrialIndex = {"timetrialindex", "计时赛", "已选择的计时赛", {{0, "标准计时赛"}, {1, "RC 小班迪托计时赛"}, {2, "Junk Energy 自行车计时赛"}}};

	static ListCommand streetDealerIndex = {"streetdealerindex", "街头毒贩", "已选择的街头毒贩", {{0, "街头毒贩 1"}, {1, "街头毒贩 2"}, {2, "街头毒贩 3"}}};

	static ListCommand lsTagIndex = {"lstagindex", "LS 涂鸦", "已选择的 LS 涂鸦", {{0, "LS 涂鸦 1"}, {1, "LS 涂鸦 2"}, {2, "LS 涂鸦 3"}, {3, "LS 涂鸦 4"}, {4, "LS 涂鸦 5"}}};

	static ListCommand animalIndex = {"animalindex", "动物", "已选择的动物", {{0, "动物 1"}, {1, "动物 2"}, {2, "动物 3"}}};

	static ListCommand productIndex = {"productindex", "商品", "已选择的商品", {{0, "商品 1"}, {1, "商品 2"}, {2, "商品 3"}, {3, "商品 4"}, {4, "商品 5"}, {5, "商品 6"}, {6, "商品 7"}, {7, "商品 8"}, {8, "商品 9"}, {9, "商品 10"}}};
