...
namespace YimMenu::Features
{
	...
	{
		static IntCommand _DiamondCasinoHeistCut1{"diamondcasinoheistcut1", "玩家 1", "玩家 1 分成", std::nullopt, std::nullopt, 0};
		static IntCommand _DiamondCasinoHeistCut2{"diamondcasinoheistcut2", "玩家 2", "玩家 2 分成", std::nullopt, std::nullopt, 0};
		static IntCommand _DiamondCasinoHeistCut3{"diamondcasinoheistcut3", "玩家 3", "玩家 3 分成", std::nullopt, std::nullopt, 0};
		static IntCommand _DiamondCasinoHeistCut4{"diamondcasinoheistcut4", "玩家 4", "玩家 4 分成", std::nullopt, std::nullopt, 0};
		...
		static ListCommand _DiamondCasinoHeistDifficulty{"diamondcasinoheistdifficulty", "难度", "抢劫任务难度", diamondCasinoHeistDifficulty, 0};
		...
		static SetPotentialTake _DiamondCasinoHeistSetPotentialTake{"diamondcasinoheistsetpotentialtake", "Set Potential Take", "更新预计收益"};
		static SetActualTake _DiamondCasinoHeistSetActualTake{"diamondcasinoheistsetactualtake", "Set Actual Take", "更新实际收益"};
