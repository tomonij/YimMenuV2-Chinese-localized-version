...
{
	static BoolCommand _AutoUpdateEnabled{"playerdbautoupdate", "玩家数据库自动更新", "每 3 分钟自动更新被追踪玩家的状态。追踪通知需要启用此功能", true};
	static BoolCommand _PlayerTracking{"playerdbnotify", "追踪通知", "当被追踪玩家的状态发生变化时通知你", true};
	static BoolCommand _NotifyWhenJoinable{"playerdbnotifywhenjoinable", "可加入时通知", "当被追踪玩家可以加入时通知你", true};
	static BoolCommand _NotifyWhenUnjoinable{"playerdbnotifywhenunjoinable", "无法加入时通知", "当被追踪玩家无法加入时通知你", true};
	static BoolCommand _NotifyWhenOnline{"playerdbnotifywhenonline", "上线时通知", "当被追踪玩家上线时通知你", true};
	static BoolCommand _NotifyWhenOffline{"playerdbnotifywhenoffline", "离线时通知", "当被追踪玩家离线时通知你", true};
	static BoolCommand _NotifyOnSessionTypeChange{"playerdbnotifyonseschange", "会话类型变化时通知", "当被追踪玩家的会话类型发生变化时通知你"};
	static BoolCommand _NotifyOnMissionChange{"playerdbnotifyonmischange", "任务状态变化时通知", "当被追踪玩家加入或离开任务时通知你"};
	static BoolCommand _NotifyOnTransitionChange{"playerdbnotifyonjoblobby", "任务大厅变化时通知", "当被追踪玩家加入或离开任务大厅时通知你"};
